        ...
        <>
            <article className="prose">
              ...
              <h2 id="component2">Form Input</h2>
               ...
               <p> This example is from add new machine modal, here we are importing component for creating text input and passing some props to handle its content and state variable. Description of props are as follows - </p>
                <ul>
